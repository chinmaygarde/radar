...
#ifndef YY_RL_PARSER_H_INCLUDED
# define YY_RL_PARSER_H_INCLUDED
...
namespace rl {
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    Parser (rl::Driver& driver_yyarg, void *scanner_yyarg);
    virtual ~Parser ();
  ...
  Parser::symbol_type
  Parser::make_INVALID_TOKEN (const location_type& l)
  {
    return symbol_type (token::RL_TOK_INVALID_TOKEN, l);
  }

  Parser::symbol_type
  Parser::make_PROTOCOL (const location_type& l)
  {
  ...
  Parser::symbol_type
  Parser::make_SEMI_COLON (const location_type& l)
  {
    return symbol_type (token::RL_TOK_SEMI_COLON, l);
  }

  Parser::symbol_type
  Parser::make_CURLY_LEFT (const location_type& l)
  {
    return symbol_type (token::RL_TOK_CURLY_LEFT, l);
  }

  Parser::symbol_type
  Parser::make_CURLY_RIGHT (const location_type& l)
  {
    return symbol_type (token::RL_TOK_CURLY_RIGHT, l);
  }

  Parser::symbol_type
  Parser::make_PAREN_LEFT (const location_type& l)
  {
    return symbol_type (token::RL_TOK_PAREN_LEFT, l);
  }

  Parser::symbol_type
  Parser::make_PAREN_RIGHT (const location_type& l)
  {
    return symbol_type (token::RL_TOK_PAREN_RIGHT, l);
  }

  Parser::symbol_type
  Parser::make_SQUARE_LEFT (const location_type& l)
  {
    return symbol_type (token::RL_TOK_SQUARE_LEFT, l);
  }

  Parser::symbol_type
  Parser::make_SQUARE_RIGHT (const location_type& l)
  {
