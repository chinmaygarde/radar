...
inline SVGPathParser::syntax_error::syntax_error(const location_type& l,
                                                 const std::string& m)
    : std::runtime_error(m), location(l) {}

// basic_symbol.
template <typename Base>
inline SVGPathParser::basic_symbol<Base>::basic_symbol() : value() {}

template <typename Base>
inline SVGPathParser::basic_symbol<Base>::basic_symbol(
...
template <typename Base>
inline void SVGPathParser::basic_symbol<Base>::clear() {
  // User destructor.
...
template <typename Base>
inline bool SVGPathParser::basic_symbol<Base>::empty() const {
...
// by_type.
inline SVGPathParser::by_type::by_type() : type(empty_symbol) {}

inline SVGPathParser::by_type::by_type(const by_type& other)
    : type(other.type) {}

inline SVGPathParser::by_type::by_type(token_type t) : type(yytranslate_(t)) {}

inline void SVGPathParser::by_type::clear() {
  type = empty_symbol;
}

inline void SVGPathParser::by_type::move(by_type& that) {
  type = that.type;
  that.clear();
}

inline int SVGPathParser::by_type::type_get() const {
  return type;
}

inline SVGPathParser::token_type SVGPathParser::by_type::token() const {
...
SVGPathParser::symbol_type SVGPathParser::make_END(const location_type& l) {
