...
class Simulation {
 public:
   ...
   *  @return the position
   */
  virtual double x(const core::ClockDuration& time) const = 0;
   ...
   *  @return the velocity
   */
  virtual double dx(const core::ClockDuration& time) const = 0;
   ...
   */
  virtual bool isDone(const core::ClockDuration& time) const = 0;
};
